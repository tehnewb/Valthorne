...
/**
 * NanoVG variant. Small vector folder/document marker shared by chooser trees and detail rows.
 * It borrows the root's NanoVG context and allocates no texture or native resource.
 * @author Albert Beaupre
 */
final class NanoFileIcon extends NanoPanel implements NanoNode {
     ...
     */
    NanoFileIcon(boolean directory) { this.directory = directory; setClickable(false); }
