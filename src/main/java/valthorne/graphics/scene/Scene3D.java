...
public final class Scene3D {
    ...
    // Allocation-free indexed traversal; membership must remain stable during collection.
    ...
    /**
     * Borrows a direct renderable in insertion order for renderer collection.
     ...
     */
    public Renderable3D renderableAt(int index) {
     ...
     * @throws IndexOutOfBoundsException if index is outside the current list
     */
    public SceneNode3D nodeAt(int index) {
