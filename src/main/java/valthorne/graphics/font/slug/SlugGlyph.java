...
public final class SlugGlyph {
     ...
     */
    SlugGlyph(int codepoint, float advance, float leftSideBearing, float x0, float y0, float x1, float y1, int glyphPack, int glyphInfoPack, float bandScaleX, float bandScaleY, float bandOffsetX, float bandOffsetY, boolean drawable) {
