...
public class NanoWindow extends NanoPanel {
    ...
    private final NanoButton closeButton = new NanoButton("X"); // Independent title-bar close control, above the move handle.
    ...
    private final class Grip extends NanoButton {
        ...
        @Override public void onMouseDrag(MouseDragEvent event) {
            ...
            var point = NanoWindow.this.getParent().screenToLocal(event.getToX(), event.getToY());
