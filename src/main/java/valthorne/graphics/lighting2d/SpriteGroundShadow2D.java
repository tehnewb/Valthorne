...
public final class SpriteGroundShadow2D {
    ...
    public SpriteGroundShadow2D(Sprite sprite) {this.sprite=Objects.requireNonNull(sprite);}
    public Sprite getSprite(){return sprite;}
    public SpriteGroundShadow2D setHeight(float value){PointLight2D.nonnegative(value);height=value;return this;}
    public SpriteGroundShadow2D setMaxLength(float value){PointLight2D.nonnegative(value);maxLength=value;return this;}
    public SpriteGroundShadow2D setOpacity(float value){PointLight2D.nonnegative(value);if(value>1)throw new IllegalArgumentException("Opacity exceeds one");opacity=value;return this;}
    public SpriteGroundShadow2D setEnabled(boolean value){enabled=value;return this;}
    ...
    public SpriteGroundShadow2D setFrameAnchors(float footU,float footV,float artworkTopV){
        PointLight2D.finite(footU);PointLight2D.finite(footV);PointLight2D.finite(artworkTopV);
        ...
        anchorU=footU;anchorV=footV;topV=artworkTopV;return this;
    }
