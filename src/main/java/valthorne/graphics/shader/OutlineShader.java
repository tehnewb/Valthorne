...
public class OutlineShader extends TexturedQuadShader {
     ...
     * @param thicknessPx outline sampling extent in texture pixels
     * @param r outline red component
     * @param g outline green component
     * @param b outline blue component
     * @param a outline alpha component
     */
