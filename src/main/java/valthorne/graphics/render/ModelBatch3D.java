...
import valthorne.graphics.scene.BillboardRenderable3D;
import valthorne.graphics.scene.BillboardSprite3D;
import valthorne.graphics.model.Material3D;
import valthorne.graphics.scene.MeshRenderable3D;
...
public final class ModelBatch3D implements AutoCloseable {
     ...
     * @throws IllegalStateException if no frame is active
     */
    public boolean rejectSubtree(AABBf bounds, int models) {
        ensureBegun();
