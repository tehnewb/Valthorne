...
/**
 * NanoVG variant. Mutually exclusive, vertically arranged labeled choices. Selection is stored by
 ...
 * <pre>{@code
 * NanoRadioGroup mode = new NanoRadioGroup(List.of("Windowed", "Fullscreen"));
...
public class NanoRadioGroup extends NanoContainer {
    ...
    private final List<NanoButton> buttons = new java.util.ArrayList<>(); // Owned choice controls.
     ...
     */
    public NanoRadioGroup selectedIndex(int index) {
