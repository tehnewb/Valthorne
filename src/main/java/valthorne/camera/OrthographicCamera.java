...
/**
 * The {@code OrthographicCamera} class provides a standard 2D orthographic camera.
 * It extends {@link Camera} and constructs an axis-aligned orthographic projection
