...
/**
 * Bounded numeric editor with decrement/increment buttons and editable decimal text.
 ...
 * <pre>{@code
 * NumberSpinner count = new NumberSpinner(0, 100, 1, 10);
...
public class NumberSpinner extends Panel {
    ...
    private final TextField editor = new TextField(); // Owned decimal-entry control.
    private final Button decrease = new Button("-"); // Owned decrement action.
    private final Button increase = new Button("+"); // Owned increment action.
     ...
     */
    public NumberSpinner(double min, double max, double step, double value) {
     ...
     */
    public NumberSpinner value(double value) {
     ...
     * @return this spinner
     */
    public NumberSpinner onChange(DoubleConsumer listener) { change = Objects.requireNonNull(listener); return this; }
