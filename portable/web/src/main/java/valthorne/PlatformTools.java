...
public final class PlatformTools {
 ...
 public static void capture(String path,int width,int height){try{var file=java.nio.file.Path.of(path);if(file.getParent()!=null)java.nio.file.Files.createDirectories(file.getParent());java.nio.file.Files.write(file,pixels(width,height));}catch(java.io.IOException error){throw new java.io.UncheckedIOException(error);}}
