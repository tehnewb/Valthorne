...
public final class FilamentRenderer3D implements AutoCloseable {
    ...
    private JSObject upload(Model3D model){
        ...
        for(Model3D.Triangle t:model.getTriangleView()){
        ...
        int[] indices=new int[count];int unique=VertexCompaction3D.compact(data,12,indices);var b=model.getLocalBounds();
